...
#ifndef   _PLATFORM_TURTLEGENERICFRAME_H_
#define   _PLATFORM_TURTLEGENERICFRAME_H_
...
{        
  ...
  **/
  class turtleGenericFrame : public gams::platforms::BasePlatform
  {
  public:
    /**
     * Constructor
  ...
  /**
   * A factory class for creating turtleGenericFrame platforms
   **/
  class turtleGenericFrameFactory : public gams::platforms::PlatformFactory
  {
  public:
    /**
     * Creates a turtleGenericFrame platform.
...
#endif // _PLATFORM_TURTLEGENERICFRAME_H_
